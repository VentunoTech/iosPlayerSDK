#
#  Be sure to run `pod spec lint VentunoPlayerSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "Ventuno Player SDK is base tool for integrating ventuno player into your app"
